...
public class NationalParkServiceImpl  implements NationalParkService {
    ...
    @Override
    public NationalPark create(String name, Double areaSize,
                               Double rating, ParkType parkType,
                               Long locationId) {
        ...
        ParkLocation parkLocation = parkLocationService
                .findById(locationId);
    ...
    @Override
    public NationalPark update(Long id, String name,
                               Double areaSize, Double rating,
                               ParkType parkType, Long locationId) {
        if (name == null || name.isEmpty() ||
                areaSize == null || areaSize <= 0 ||
                rating == null || rating < 0 ||
                parkType == null ||
